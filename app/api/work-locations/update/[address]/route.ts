...
export async function PUT(
  ...
  console.log("✅ Update work location API route called")
  ...
  try {
    ...
    console.log("📍 Address parameter:", resolvedParams.address)
    ...
    console.log("🚀 Sending update request to backend API...")

    // Decode the address parameter in case it was URL encoded
    const decodedAddress = decodeURIComponent(resolvedParams.address)

    const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/locations/update/${decodedAddress}`, {
      method: "PUT",
      headers: {
